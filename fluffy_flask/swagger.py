"""
Description: patched swagger of fluffy_flask
version: 0.1.1
Author: 1746104160
Date: 2023-06-02 12:56:56
LastEditors: 1746104160 shaojiahong2001@outlook.com
LastEditTime: 2023-06-04 21:45:14
FilePath: /fluffy_flask/fluffy_flask/swagger.py
"""
...
class Swagger(OriginalSwagger):
    ...
    def parameters_for(self, doc: dict[str, Schema]) -> list[dict]:
        ...
        for field_name, field_obj in fields.items():
            ...
            if location == "body":
                ...
                if data["type"] == "array":
                    ...
                    data["items"] = {"type": DEFAULT_FIELD_MAPPING[list_field.inner.__class__]}
        ...
        if json_fields:
            json_schema: dict[str, Field] = converter.fields2jsonschema(json_fields)
