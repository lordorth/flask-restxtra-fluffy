...
FilePath: /flask_restxtra_fluffy/examples/app/managers/route_manager/resources.py
"""
...
route_ns: Namespace = Namespace("route", description="interface for route management")
...
class RouteInfo(Resource):
    ...
    @route_ns.parameters(GetRoutesInfoParameters(add_jwt=Config.DEVELOPING), location="query")
    @route_ns.response(
        code=HTTPStatus.OK,
