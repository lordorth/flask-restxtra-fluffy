...
FilePath: /flask_restxtra_fluffy/examples/app/managers/role_manager/resources.py
"""
...
role_ns: Namespace = Namespace("role", description="interface for role management")
